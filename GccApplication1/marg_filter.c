// Math library required for ÅesqrtÅf
#include <math.h>

// System constants
#define deltat 0.01f // sampling period in seconds (shown as 1 ms)
#define gyroMeasError 3.14159265358979 * (60.0f / 180.0f) // gyroscope measurement error in rad/s (shown as 5 deg/s)
#define gyroMeasDrift 3.14159265358979 * (1.0f / 180.0f) // gyroscope measurement error in rad/s/s (shown as 0.2f deg/s/s)
